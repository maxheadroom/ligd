...
*/
    ...
    if ( ! function_exists( 'nisarg_footer_posted_on' ) ) :
        /**
         * Prints HTML with meta information for the current post-date/time and author.
         */
        function nisarg_footer_posted_on() {
     ...
     */
    function nisarg_new_ligd_excerpt_more( $more ) {
        return '...<p class="read-more"><a class="btn btn-default" href="'. esc_url( get_permalink( get_the_ID() ) ) . '">' . __( ' Read More', 'nisarg' ) . '<span class="screen-reader-text"> '. __( ' Read More', 'nisarg' ).'</span></a><br /><span class="read-more-date">ver&ouml;ffentlicht am '.  esc_html( get_the_date() )  .'</span></p>';
    }

    add_filter( 'excerpt_more', 'nisarg_new_ligd_excerpt_more', 15 , 1 );
